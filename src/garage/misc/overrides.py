...
def overrides(method):
    ...
    <http://stackoverflow.com/a/14631397/308189>`_

    `my answer: http://stackoverflow.com/a/8313042/308189
    <http://stackoverflow.com/a/8313042/308189>`_
    ...
    Raises:
        AssertionError: if no match in super classes for the method name
    Returns:
        method with possibly added (if the method doesn't have one) docstring
        from super class
    """
